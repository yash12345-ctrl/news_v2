	...
	<div class="container">
		<div class="section-wrapper">
			<div class="filter-wrapper">
				<form class="filter-form" action="/guldastah" method="get">
					<div class="filters">
						<div class="filter-date">
							<label class="form-label">Find Guldastah By Date</label>
							<input type="date" name="date" id="date" class="form-input" value="{{ request('date') ?? ($guldastah && $guldastah->created_at ? $guldastah->created_at->format('Y-m-d') : '') }}">
						</div>
					</div>
				...
				<div class="share-icons">
					<h3 class="share-icons-title">Share Guldastah</h3>
					<div class="article-section-details-socials">
						<a href="https://twitter.com/intent/tweet?text={{ $share_url }}&url={{ $share_url }}">
						...
						<a href="https://wa.me/?text={{ $share_url }}">
							<div class="article-section-details-social">
							<span>
			...
			<div class="e-papers-thumbnails">
				...
				@foreach ($pages as $p)
					<a href="/guldastah/{{ $guldastah->id }}/{{ $p->page_number }}" class="e-papers-thumbnail">
						<div class="e-papers-thumbnail-poster">
							<img class="e-papers-thumbnail-poster-image is-active" src="{{ $p->page_sm_url }}">
						</div>
						<span class="e-papers-thumbnail-page is-active">Page {{ $p->page_number }}</span>
					</a>
				@endforeach
			...
			@if ($active_page && $active_page->first())
				<img class="e-paper-single-poster-image" src="{{ $active_page->page_url }}">
			@endif
